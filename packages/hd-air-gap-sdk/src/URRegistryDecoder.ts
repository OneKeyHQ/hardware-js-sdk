...
export class URRegistryDecoder extends URDecoder {
  public resultRegistryType = () => {
    ...
    switch (ur.type) {
      ...
      case RegistryTypes.ETH_SIGN_REQUEST.getType():
        return EthSignRequest.fromCBOR(ur.cbor);
      case RegistryTypes.ETH_SIGNATURE.getType():
        return EthSignRequest.fromCBOR(ur.cbor);
      case RegistryTypes.ETH_NFT_ITEM.getType():
        return ETHNFTItem.fromCBOR(ur.cbor);
      default:
