/**
 * Parse an x509 certificate returned from Trezor (AuthenticityProof) from DER format.
 * Ported from @trezor/device-authenticity (self-contained, no external deps).
...
// algorithms supported to verify certificates and signatures
