...
export const mapProtocolV2DeviceInfoToState = (
  ...
  return {
    ...
    versions: definedEntries({
      ...
      coprocessorBoot: imageVersion(info.coprocessor?.bootloader),
    ...
    verification: definedEntries({
      ...
      coprocessorBootBuildId: imageBuildId(info.coprocessor?.bootloader),
      coprocessorBootHash: imageHash(info.coprocessor?.bootloader),
