...
- 业务 API 基本不变：如 `searchDevices / getDeviceState / btcGetAddress`
...
- API 参考和参数：[Hardware SDK 核心 API 指南](/zh/hardware-sdk/core-api-guide)、[通用参数](/zh/hardware-sdk/concepts/common-params)、[错误码](/zh/hardware-sdk/core-api-guide#error-codes)
