...
```typescript
{
    ...
    payload: {
        ...
        signature: string;
        signing_message?: string; // Correct Pro2/Neo field; the SDK also normalizes legacy responses
        signning_message?: string; // Deprecated; retained only for raw Protocol V1 compatibility
    }
}
```
