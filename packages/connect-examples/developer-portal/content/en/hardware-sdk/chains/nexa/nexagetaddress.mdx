...
* `prefix` - _optional_ `string` Address prefix, for example `nexa` for mainnet; specify the intended network explicitly
...
* `bundle` - `Array` of Objects with `path`, `prefix`, `scheme`, `showOnOneKey` fields
