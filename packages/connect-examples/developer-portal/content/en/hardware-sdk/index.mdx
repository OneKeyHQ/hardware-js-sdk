...
Hardware SDK **1.2.1** is the current stable line. It speaks Protocol V1 and Protocol V2 through the same JavaScript API. New here? Start with [Getting Started](/en/hardware-sdk/getting-started).
...
```mermaid
flowchart TB
  App["Your app"] --> SDK["HardwareSDK"]
  SDK --> Transport["Transport: USB / BLE / low-level"]
  Transport --> Protocol["Protocol V1 or V2 — live probe"]
