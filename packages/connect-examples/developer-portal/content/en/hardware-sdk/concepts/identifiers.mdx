...
> `useEmptyPassphrase`, …)? See [Common Params](../common-params).
...
- [Common Params](../common-params) — parameters you pass **in** to SDK calls
- [Passphrase](./passphrase) — hidden wallet flow
- [PIN Code](./pin) — PIN entry flow
- [Search Devices](../basic-api/search-devices) — returns `connectId`, `uuid`, `deviceType`, `deviceId`
- [Get Features](../basic-api/get-features) — returns `device_id`, `session_id`, `onekey_serial`, …
