...
Preferred path: [`openWalletSession`](/en/hardware-sdk/basic-api/open-wallet-session), then pass `passphraseState` on later calls. The `getPassphraseState` flow below is **deprecated** and kept for existing apps.
