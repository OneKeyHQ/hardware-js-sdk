...
Use [`getDeviceState`](/en/hardware-sdk/basic-api/get-device-state). `getFeatures` is Protocol V1 only (Classic / Mini / Touch / Pro); Pro 2 and Neo reject it before any compatibility projection. `getDeviceState` still includes a Features-shaped snapshot for V1 and V2.
