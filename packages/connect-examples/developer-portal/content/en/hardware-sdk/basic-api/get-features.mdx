...
<Callout type="warning">
  **Deprecated. Protocol V1 only.** Use [`getDeviceState`](/en/hardware-sdk/basic-api/get-device-state) for Protocol V1 and V2. Classic / Mini / Touch / Pro can still call this method; Pro 2 and Neo reject it.
</Callout>

## Get device features

Get all attributes of the device. New code should read [`getDeviceState`](/en/hardware-sdk/basic-api/get-device-state) (`payload.identity.deviceId`).
