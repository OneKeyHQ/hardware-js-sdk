...
- Read [Low-Level Transport Plugin & Protocol](/en/hardware-sdk/concepts/low-level-plugin) before wiring native BLE to understand raw BLE notification forwarding and SDK-owned V1/V2 framing.
