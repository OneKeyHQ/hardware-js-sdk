...
// BLE returns id + name; read identity via getDeviceState
...
- [Error Code](/en/hardware-sdk/core-api-guide#error-codes), [Common Params](/en/hardware-sdk/concepts/common-params)
