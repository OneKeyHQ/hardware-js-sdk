...
| `derivationPath` | [`CryptoKeypath`](/en/air-gap/basic-api/cryptokeypath) | Derivation path |
...
After the device signs, decode the response using [EthSignature](/en/air-gap/ethereum-and-evm/ethsignature).
