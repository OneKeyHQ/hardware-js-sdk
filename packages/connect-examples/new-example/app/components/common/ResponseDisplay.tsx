...
const ResponseDisplay: React.FC<ResponseDisplayProps> = ({ response, title }) => {
  ...
  return (
    <Card>
      <CardHeader className="pb-2 flex flex-row items-center justify-between">
        <CardTitle className="text-lg">{title || t('common.response')}</CardTitle>
        <Button
          variant="ghost"
          size="sm"
      ...
      <CardContent>
        {!response ? (
          <div className="text-center text-muted-foreground py-6">{t('common.noResponse')}</div>
        ) : (
          <div>
