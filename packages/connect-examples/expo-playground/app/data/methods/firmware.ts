...
const api: UnifiedMethodConfig[] = [
  ...
  },
  {
    ...
    noDeviceIdReq: true,
    // 按 DevFirmwareTargetType（FwMgmtTarget_t）拆分为独立预设，每个 target 可单独更新
    presets: [
      {
        title: 'Application (P1 / P2)',
        description: 'TARGET_APPLICATION_P1 = 3, TARGET_APPLICATION_P2 = 4',
        parameters: [
          {
            name: 'platform',
            type: 'select',
          ...
          },
          {
            ...
            type: 'file',
            required: false,
            label: 'Application P1 Binary',
            description: 'Main application partition 1 (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
          {
            ...
            type: 'file',
            required: false,
            label: 'Application P2 Binary',
            description: 'Main application partition 2 (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
      ...
      {
        title: 'Bootloader / Romloader',
        description: 'TARGET_ROMLOADER = 1, TARGET_BOOTLOADER = 2',
        parameters: [
          {
            name: 'platform',
            type: 'select',
          ...
          },
          {
            ...
            type: 'file',
            required: false,
            label: 'Romloader Binary',
            description: 'Romloader image (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
          {
            ...
            required: false,
            label: 'Bootloader Binary',
            description: 'Bootloader image (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
      ...
      {
        title: 'Coprocessor (BLE)',
        description: 'TARGET_COPROCESSOR = 5',
        parameters: [
          {
            name: 'platform',
            type: 'select',
          ...
          },
          {
            ...
            type: 'file',
            required: false,
            label: 'Coprocessor Binary',
            description: 'Bluetooth coprocessor firmware (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
      ...
      {
        title: 'Secure Elements (SE01-04)',
        description: 'TARGET_SE01-04 = 6-9',
        parameters: [
          {
            name: 'platform',
            type: 'select',
          ...
          },
          {
            ...
            required: false,
            label: 'SE01 Binary',
            description: 'Secure element 1 firmware (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
          {
            ...
            required: false,
            label: 'SE02 Binary',
            description: 'Secure element 2 firmware (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
          {
            ...
            required: false,
            label: 'SE03 Binary',
            description: 'Secure element 3 firmware (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
          {
            ...
            required: false,
            label: 'SE04 Binary',
            description: 'Secure element 4 firmware (.bin)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
      ...
      {
        title: 'Resource',
        description: 'TARGET_RESOURCE = 10',
        parameters: [
          {
            name: 'platform',
            type: 'select',
