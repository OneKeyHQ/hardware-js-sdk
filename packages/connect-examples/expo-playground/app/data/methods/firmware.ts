    ...
    presets: [
      {
        ...
        parameters: [
          ...
          {
            name: 'romloaderBinary',
            type: 'file',
            required: false,
            label: 'Romloader (target 1)',
            accept: '.bin',
            visible: true,
            editable: true,
          },
          ...
          },
          {
            ...
            type: 'file',
            required: false,
            label: 'Resource (target 10)',
            description: 'Resource bundle: .zip is unpacked and uploaded per file, .bin uploads as a single file',
            accept: '.zip,.bin',
            visible: true,
            editable: true,
          },
