export const en = {
  translation: {
    ...
    methodDescriptions: {
      ...
      devGetDeviceInfo: 'Protocol V2 device information query',
      devGetOnboardingStatus: 'Protocol V2 onboarding status query',
      devFirmwareUpdate: 'Protocol V2 firmware install trigger',
      devGetFirmwareUpdateStatus: 'Protocol V2 firmware install status query',
