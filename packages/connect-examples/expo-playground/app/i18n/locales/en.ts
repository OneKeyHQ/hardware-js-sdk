export const en = {
  translation: {
    ...
    methodDescriptions: {
      ...
      firmwareUpdateV4:
        'Protocol V2 firmware update split by DevFirmwareTargetType: romloader, bootloader, application P1/P2, coprocessor, SE01-04 and resource targets',
      ...
      deviceGetDeviceInfo:
        'Raw Protocol V2 DevGetDeviceInfo (no DeviceProfile wrapping, Pro2 only); pick request targets/types via checkboxes',
      ...
      factoryDeviceInfoSettings: 'Protocol V2 factory-mode device information write',
      factoryGetDeviceInfo: 'Protocol V2 factory-mode device information query',
      filesystemFixPermission: 'Protocol V2 filesystem permission repair',
