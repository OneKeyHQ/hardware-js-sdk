export const en = {
  translation: {
    ...
    home: {
      ...
      step2: 'Choose a transport method (WebUSB or Emulator)',
    ...
    methodDescriptions: {
      ...
      detectDeviceConnectProtocol: 'Detect the protocol from an active device response',
      getDeviceState: 'Get the unified Protocol V1/V2 device state',
      ...
      openWalletSession: 'Open or resume a unified Protocol V1/V2 wallet session',
      deviceUnlock: 'Unlock the device',
      testProtocolV2Ping: 'Test the Protocol V2 communication link',
      deviceGetOnboardingStatus: 'Get the Pro2 onboarding status',
      deviceReboot: 'Reboot Pro2 into the selected runtime mode',
      deviceUploadWallpaper: 'Upload and apply a Pro2 wallpaper',
      deviceUploadNft: 'Upload Pro2 NFT images and metadata',
      uploadPortfolio: 'Upload a Pro2 portfolio package',
    ...
    portfolioTest: {
      title: 'Pro2 Portfolio Test Suite',
      description:
        'Validate amount formatting, Native/Contract/All Networks token mapping, the exact JSON structure, and firmware boundaries. Batch mode runs every {{intervalSeconds}} seconds; positive cases must complete upload and PortfolioUpdate, while negative cases must return the expected rejection reason.',
      resetResults: 'Clear results',
      stopBatch: 'Stop remaining cases',
      runAll: 'Run all cases',
      device: 'Device',
      connecting: 'Connecting...',
      notConnected: 'Pro 2 not connected',
      progress: 'Test progress',
      progressValue: '{{completed}}/{{total}}, {{passed}} passed',
      firmwareSource: 'Firmware rules source',
      nextCase: 'Next case',
      seconds: '{{count}} seconds',
      sdkReady: 'Ready',
      sdkNotReady: 'Not ready',
      signedPackages: '{{count}} signed packages',
      clientBlocks: '{{count}} client-side blocks',
      interval: '{{intervalSeconds}}-second interval',
      packageNotice:
        'Test packages are generated with the standard firmware-pro2 packager and development signature. They only work with test firmware that accepts development RESOURCE packages. Client-side block cases never send bytes to the device.',
      loadingCases: 'Loading test cases...',
      verifyBlock: 'Verify block',
      run: 'Run',
      viewPayload: 'View payload and expectation',
      expected: 'Expected',
      packageFile: 'Package file',
      noPackage: 'None (sending prohibited)',
      matchMessage: 'Match message',
      searchAndConnect: 'Search and connect Pro 2',
      status: {
        idle: 'Not run',
        running: 'Running',
        passed: 'Passed',
      ...
      expectation: {
        accept: 'Firmware accepts',
        reject: 'Firmware rejects',
        'client-block': 'Client blocks',
      },
      errors: {
        unknown: 'Unknown error',
        sdkWithoutMessage: 'The SDK call failed without an error message',
        deviceNotFound: 'OneKey Pro 2 was not found',
        clientDidNotBlock: 'The client did not block an amount with more than 7 significant digits',
        blockedBeforeSend: '{{error}}; no bytes were sent to the device',
        deviceRequired: 'Connect OneKey Pro 2 before running a hardware case',
        connectIdMissing: 'OneKey Pro 2 has no connectId',
        packageMissing: 'This case has no .okpkg file',
        packageLoadFailed: 'Failed to load {{packageName}}: HTTP {{status}}',
        uploadSucceeded: 'FilesystemFileWrite and PortfolioUpdate both succeeded',
        rejectedAsExpected: 'Rejected as expected: {{message}}',
        unexpectedRejectReason:
          'Expected a rejection containing "{{expectedError}}", received: {{message}}',
      },
    },
    firmware: {
      webusb: {
