...
import { Cpu, FileCode2, LockKeyhole, Settings, Zap } from 'lucide-react';
...
const PRO2_METHOD_GROUPS = [
  ...
  },
  {
    ...
    title: 'Settings',
    icon: Settings,
    methods: ['deviceSettings', 'deviceUploadWallpaper'],
  },
  {
    id: 'firmware',
    title: 'Firmware',
...
const PRO2_METHOD_LABELS: Record<string, string> = {
  ...
  openWalletSession: 'Wallet Session',
  deviceCancel: 'Cancel',
...
const PRO2_METHOD_WIRE_INFO: Record<string, MethodWireInfo> = {
  ...
  deviceUnlock: {
    ...
    rx: '60207 (Success), followed by 60603 (DeviceStatus)',
    rxPayload: PRO2_DYNAMIC_RESPONSE,
    decoded: 'Canonical DeviceState with unlocked=true',
  },
  deviceLock: {
    tx: '24 (LockDevice)',
  ...
  deviceSettings: {
    tx: 'DeviceSettingsSet or DeviceSettingsPageShow',
    txPayload: 'Canonical settings payload mapped by the detected protocol',
    rx: '60207 (Success), followed by state verification for on-device pages',
    rxPayload: PRO2_DYNAMIC_RESPONSE,
    decoded: 'Success.message + canonical DeviceState update',
  },
