...
const SENSITIVE_PATTERNS = [/xprv[1-9A-HJ-NP-Za-km-z]+/, /"private_key"\s*:/i, /"privateKey"\s*:/];

export function assertNoSensitiveMaterial(content: string, mnemonics: MultisigMnemonics): void {
  if (
...
export function renderMultisigFixtures(
  ...
  const content =
    `// Generated by generate:multisig-fixtures. Do not edit manually.\n` +
    `// Contains public, offline, non-broadcastable test data only.\n\n` +
