...
const pointAddScalar = (p: Uint8Array, tweak: Uint8Array, isCompressed?: boolean) => {
...
const pointMultiply = (p: Uint8Array, tweak: Uint8Array, isCompressed?: boolean) => {
  const P = necc.Point.fromHex(p);
...
const ecc = {
  ...
  xOnlyPointAddTweak: (p: Uint8Array, tweak: Uint8Array) =>
    throwToNull(() => {
      ...
      return { parity, xOnlyPubkey: P.slice(1) } as XOnlyPointAddTweakResult;
    }),
  ...
  privateAdd: (d: Uint8Array, tweak: Uint8Array) => throwToNull(() => privateAdd(d, tweak)),
  ...
  verify: (h: Uint8Array, Q: Uint8Array, signature: Uint8Array, strict?: boolean) =>
