...
// Export all type definitions (safe for renderer process)
export * from './types';

// Noble BLE functionality (only for main process)
export async function initNobleBleSupport(webContents: WebContents) {
  // Dynamic import to avoid bundling Noble in renderer process
